...
class homeModel {
    ...
    //select Drink
    static searchDrinks(inputSelect, result) {
    ...
    // Update Home
    static updateDrink(newHome, result) {
    ...
    // Delete by select
    static deleteSelect(listSelect, results) {
